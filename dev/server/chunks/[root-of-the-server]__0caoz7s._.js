...
"[project]/app/api/graphql/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const resolvers = {
    Query: {
        students: async ()=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].student.findMany();
        }
    },
    Mutation: {
        addStudent: async (_, args)=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].student.create({
                data: {
                    name: args.name,
                    email: args.email,
        ...
        updateStudent: async (_, args)=>{
            return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].student.update({
                where: {
                    id: args.id
                },
                data: {
        ...
        deleteStudent: async (_, args)=>{
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].student.delete({
                where: {
                    id: args.id
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0caoz7s._.js.map