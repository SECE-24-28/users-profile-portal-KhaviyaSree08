...
async function runHttpQuery({ server, httpRequest, contextValue, schemaDerivedData, internals, sharedResponseHTTPGraphQLHead }) {
        ...
        case 'GET':
            {
                ...
                if (contentType !== undefined) {
                    ...
                    if (contentTypeParsed === null || contentTypeParsed.essence !== 'application/json') {
                        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$internalErrorClasses$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('GET requests may not have a content-type header other than application/json.', {
                            extensions: {
                                http: newHTTPGraphQLHead(415)
                            }
                        });
                    }
                }
    ...
    const negotiator = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$negotiator$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
        headers: {
            accept: acceptHeader
        }
    });
    const preferredMediaType = negotiator.mediaType([
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9,
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2
    ]);
    if (!acceptHeader || preferredMediaType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2 && preferredMediaType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9) {
        throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$internalErrorClasses$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Apollo server received an operation that uses incremental delivery ' + '(@defer or @stream), but the client does not accept multipart/mixed ' + 'HTTP responses. To enable incremental delivery support, add the HTTP ' + `header 'Accept: ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9}' ` + 'if your client supports the current incremental format or ' + `'Accept: ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2}' if your ` + 'client supports the legacy incremental format', {
            extensions: {
                http: {
                    status: 406
                }
...
__turbopack_context__.s([
    "makeGatewayGraphQLRequestContext",
    ()=>makeGatewayGraphQLRequestContext
]);
function makeGatewayGraphQLRequestContext(newRequestContext, server, internals) {
    const request = {};
...
async function tryToLoadGraphQL17() {
    ...
    const graphql = await __turbopack_context__.A("[project]/node_modules/graphql/index.mjs [app-route] (ecmascript, async loader)");
    if (graphql.version === '17.0.0-alpha.9' && 'experimentalExecuteIncrementally' in graphql) {
...
async function executeIncrementally({ useLegacyIncremental, legacyExperimentalExecuteIncrementally, ...args }) {
    ...
    if (useLegacyIncremental) {
        ...
        if (graphqlExperimentalExecuteIncrementally) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$internalErrorClasses$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BadRequestError"]('Apollo Server received an operation that uses incremental delivery ' + '(@defer or @stream) with the legacy incremental format, but the server ' + 'does not support the legacy incremental delivery format. Add the HTTP ' + `header: 'Accept: ${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9}' ` + 'to use the current incremental delivery format', {
                extensions: {
                    http: {
                        status: 406
                    }
...
function isBadUserInputGraphQLError(error) {
    return error.nodes?.length === 1 && error.nodes[0].kind === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$language$2f$kinds$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Kind"].VARIABLE_DEFINITION && (error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" has invalid value`) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" got invalid value `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of required type `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of non-null type `));
}
    ...
    if (responseFromPlugin !== null) {
        ...
        try {
            const fullResult = await execute({
                ...requestContext,
                useLegacyIncremental: new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$negotiator$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]({
                    headers: {
                        accept: request.http?.headers.get('accept')
                    }
                }).mediaType([
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9,
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$apollo$2f$server$2f$dist$2f$esm$2f$ApolloServer$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MEDIA_TYPES"].MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2
        ...
        if (internals.__testing_incrementalExecutionResults) {
            ...
            if ('initialResult' in resultOrResults) {
                return {
                    ...
                    subsequentResults: 'pending' in resultOrResults.initialResult ? formatErrorsInSubsequentResultsAlpha9(resultOrResults.subsequentResults) : formatErrorsInSubsequentResultsAlpha2(resultOrResults.subsequentResults)
                };
            } else {
                return {
...
class SchemaManager {
    logger;
    schemaDerivedDataProvider;
    onSchemaLoadOrUpdateListeners = new Set();
    isStopped = false;
    schemaDerivedData;
    schemaContext;
    modeSpecificState;
...
;
;
const DEFAULT_MAX_RECURSIVE_SELECTIONS = 10_000_000;
    ...
    async addDefaultPlugins() {
        ...
        }
        {
            if (!alreadyHavePluginWithInternalId('CacheControl')) {
                const { ApolloServerPluginCacheControl } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/cacheControl/index.js [app-route] (ecmascript, async loader)");
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && apolloConfig.key) {
                if (apolloConfig.graphRef) {
                    const { ApolloServerPluginUsageReporting } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/usageReporting/index.js [app-route] (ecmascript, async loader)");
        ...
        }
        {
            ...
            if (!alreadyHavePlugin && enabledViaEnvVar) {
                if (apolloConfig.key) {
                    const { ApolloServerPluginSchemaReporting } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/schemaReporting/index.js [app-route] (ecmascript, async loader)");
        ...
        }
        {
            ...
            if (!alreadyHavePlugin) {
                const { ApolloServerPluginInlineTrace } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/inlineTrace/index.js [app-route] (ecmascript, async loader)");
        ...
        if (!alreadyHavePlugin) {
            const { ApolloServerPluginLandingPageLocalDefault, ApolloServerPluginLandingPageProductionDefault } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/landingPage/default/index.js [app-route] (ecmascript, async loader)");
        ...
        }
        {
            ...
            if (hideSchemaDetailsFromClientErrors && !alreadyHavePlugin) {
                const { ApolloServerPluginDisableSuggestions } = await __turbopack_context__.A("[project]/node_modules/@apollo/server/dist/esm/plugin/disableSuggestions/index.js [app-route] (ecmascript, async loader)");
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/resolvable.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/cachePolicy.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/determineApolloConfig.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/errors/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.ApolloServerValidationErrorCode = exports.ApolloServerErrorCode = void 0;
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/HeaderMap.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/internalErrorClasses.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/runHttpQuery.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
async function runHttpQuery({ server, httpRequest, contextValue, schemaDerivedData, internals, sharedResponseHTTPGraphQLHead }) {
        ...
        case 'GET':
            {
                ...
                if (contentType !== undefined) {
                    ...
                    if (contentTypeParsed === null || contentTypeParsed.essence !== 'application/json') {
                        throw new internalErrorClasses_js_1.BadRequestError('GET requests may not have a content-type header other than application/json.', {
                            extensions: {
                                http: newHTTPGraphQLHead(415)
                            }
                        });
    ...
    if (!acceptHeader || preferredMediaType !== ApolloServer_js_1.MEDIA_TYPES.MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2 && preferredMediaType !== ApolloServer_js_1.MEDIA_TYPES.MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9) {
        throw new internalErrorClasses_js_1.BadRequestError('Apollo server received an operation that uses incremental delivery ' + '(@defer or @stream), but the client does not accept multipart/mixed ' + 'HTTP responses. To enable incremental delivery support, add the HTTP ' + `header 'Accept: ${ApolloServer_js_1.MEDIA_TYPES.MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9}' ` + 'if your client supports the current incremental format or ' + `'Accept: ${ApolloServer_js_1.MEDIA_TYPES.MULTIPART_MIXED_EXPERIMENTAL_ALPHA_2}' if your ` + 'client supports the legacy incremental format', {
            extensions: {
                http: {
                    status: 406
                }
...
"[project]/node_modules/@apollo/server/dist/cjs/errorNormalize.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/httpBatching.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/internalPlugin.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/preventCsrf.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.recommendedCsrfPreventionRequestHeaders = void 0;
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/schemaInstrumentation.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/isDefined.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/invokeHooks.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/makeGatewayGraphQLRequestContext.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/incrementalDeliveryPolyfill.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
async function executeIncrementally({ useLegacyIncremental, legacyExperimentalExecuteIncrementally, ...args }) {
    ...
    if (useLegacyIncremental) {
        ...
        if (graphqlExperimentalExecuteIncrementally) {
            throw new internalErrorClasses_js_1.BadRequestError('Apollo Server received an operation that uses incremental delivery ' + '(@defer or @stream) with the legacy incremental format, but the server ' + 'does not support the legacy incremental delivery format. Add the HTTP ' + `header: 'Accept: ${ApolloServer_js_1.MEDIA_TYPES.MULTIPART_MIXED_EXPERIMENTAL_ALPHA_9}' ` + 'to use the current incremental delivery format', {
                extensions: {
                    http: {
                        status: 406
                    }
...
"[project]/node_modules/@apollo/server/dist/cjs/requestPipeline.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function isBadUserInputGraphQLError(error) {
    return error.nodes?.length === 1 && error.nodes[0].kind === graphql_1.Kind.VARIABLE_DEFINITION && (error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" has invalid value`) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" got invalid value `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of required type `) || error.message.startsWith(`Variable "$${error.nodes[0].variable.name.value}" of non-null type `));
}
async function processGraphQLRequest(schemaDerivedData, server, internals, requestContext) {
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/UnreachableCaseError.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/computeCoreSchemaHash.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/utils/schemaManager.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/validationRules/NoIntrospection.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/validationRules/RecursiveSelectionsLimit.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/validationRules/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/cacheControl/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const lru_cache_1 = __turbopack_context__.r("[project]/node_modules/@apollo/server/node_modules/lru-cache/dist/commonjs/node/index.min.js [app-route] (ecmascript)");
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/traceTreeBuilder.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class TraceTreeBuilder {
    rootNode = new usage_reporting_protobuf_1.Trace.Node();
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/iterateOverTrace.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/durationHistogram.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/defaultSendOperationsAsTrace.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/operationDerivedDataCache.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/stats.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class OurQueryLatencyStats {
    latencyCount = new durationHistogram_js_1.DurationHistogram();
    requestCount = 0;
    requestsWithoutFieldInstrumentation = 0;
    cacheHits = 0;
    persistedQueryHits = 0;
    persistedQueryMisses = 0;
    cacheLatencyCount = new durationHistogram_js_1.DurationHistogram();
    rootErrorStats = new OurPathErrorStats();
    requestsWithErrorsCount = 0;
    publicCacheTtlCount = new durationHistogram_js_1.DurationHistogram();
    privateCacheTtlCount = new durationHistogram_js_1.DurationHistogram();
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/traceDetails.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/generated/packageVersion.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/schemaIsSubgraph.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/plugin.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/usageReporting/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/schemaReporting/schemaReporter.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
class SchemaReporter {
    ...
    endpointUrl;
    logger;
    initialReportingDelayInMs;
    fallbackReportingDelayInMs;
    fetcher;
    isStopped;
    pollTimer;
    headers;
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/schemaReporting/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/inlineTrace/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/landingPage/default/getEmbeddedHTML.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/landingPage/default/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
        ...
        async serverWillStart () {
            return {
                async renderLandingPage () {
                    ...
                    async function html() {
                        const nonce = (0, utils_createhash_1.createHash)('sha256').update(crypto.randomUUID()).digest('hex');
...
"[project]/node_modules/@apollo/server/dist/cjs/plugin/disableSuggestions/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/ApolloServer.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/externalTypes/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/node_modules/@apollo/server/dist/cjs/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
__exportStar(__turbopack_context__.r("[project]/node_modules/@apollo/server/dist/cjs/externalTypes/index.js [app-route] (ecmascript)"), exports);
}),
];

//# sourceMappingURL=node_modules_%40apollo_server_dist_05zxeta._.js.map