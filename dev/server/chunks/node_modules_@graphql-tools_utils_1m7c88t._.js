            ...
            for(const key in source){
                ...
                if (key in output) {
                    output[key] = mergeDeep([
                        output[key],
                        source[key]
                    ], respectPrototype, respectArrays, respectArrayLength, respectNonEnumerableSymbols);
                } else {
...
function astFromValue(value, type) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$graphql$2d$tools$2f$utils$2f$esm$2f$astFromValueUntyped$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["astFromValueUntyped"])(value);
}
/**
 * IntValue:
 *   - NegativeSign? 0
...
function createGraphQLError(message, options) {
    ...
    const Constructor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$error$2f$GraphQLError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["GraphQLError"];
    const error = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$version$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["versionInfo"].major >= 16 ? new Constructor(message, options) : new Constructor(message, options?.nodes, options?.source, options?.positions, options?.path, options?.originalError, options?.extensions);
...
function locatedError(rawError, nodes, path, info) {
    const error = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$graphql$2f$error$2f$locatedError$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["locatedError"])(rawError, nodes, path);
...
//# sourceMappingURL=node_modules_%40graphql-tools_utils_1m7c88t._.js.map