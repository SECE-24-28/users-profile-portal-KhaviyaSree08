...
const lru_cache_1 = __turbopack_context__.r("[project]/node_modules/@apollo/utils.keyvaluecache/node_modules/lru-cache/dist/commonjs/node/index.min.js [app-route] (ecmascript)");
...
"[project]/node_modules/@apollo/utils.keyvaluecache/node_modules/lru-cache/dist/commonjs/node/index.min.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var I = j((O)=>{
    ...
    var U = __turbopack_context__.r("[externals]/node:diagnostics_channel [external] (node:diagnostics_channel, cjs)");
...
var g = I(), N = P(), C = ()=>g.metrics.hasSubscribers || g.tracing.hasSubscribers, k = new Set, G = typeof process == "object" && process ? process : {}, V = (c, t, e, i)=>{
...
var T = (c)=>!!c && c === Math.floor(c) && c > 0 && isFinite(c), H = (c)=>T(c) ? c <= Math.pow(2, 8) ? Uint8Array : c <= Math.pow(2, 16) ? Uint16Array : c <= Math.pow(2, 32) ? Uint32Array : c <= Number.MAX_SAFE_INTEGER ? W : null : null, W = class extends Array {
    ...
    *rentries() {
        for (let t of this.#z())this.#t[t] !== void 0 && this.#i[t] !== void 0 && !this.#e(this.#t[t]) && (yield [
            this.#i[t],
            this.#t[t]
        ]);
    }
    ...
    *rvalues() {
    ...
    purgeStale() {
        ...
        for (let e of this.#z({
            allowStale: !0
        }))this.#p(e) && (this.#v(this.#i[e], "expire"), t = !0);
        return t;
    }
    info(t) {
        let e = this.#s.get(t);
    ...
    #O(t, e, i, s) {
        ...
        if (this.maxEntrySize && y > this.maxEntrySize) return this.#v(t, "set"), o && (o.set = "miss", o.maxEntrySizeExceeded = !0), this;
        let u = this.#n === 0 ? void 0 : this.#s.get(t);
        if (u === void 0) u = this.#n === 0 ? this.#h : this.#_.length !== 0 ? this.#_.pop() : this.#n === this.#o ? this.#P(!1) : this.#n, this.#i[u] = t, this.#t[u] = e, this.#s.set(t, u), this.#l[this.#h] = u, this.#u[u] = this.#h, this.#h = u, this.#n++, this.#I(u, y, o), o && (o.set = "add"), _ = !1, this.#D && !d && this.#W?.(e, t, "add");
        else {
            this.#L(u);
            let p = this.#t[u];
            if (e !== p) {
    ...
    #G(t, e, i, s) {
        ...
        let a = {
            ...
            if (i.status && (l && !b ? (i.status.fetchAborted = !0, i.status.fetchError = r.signal.reason, S && (i.status.fetchAbortIgnored = !0)) : i.status.fetchResolved = !0), l && !S && !b) return _(r.signal.reason, F);
            let w = u, m = this.#t[e];
            return (m === u || m === void 0 && S && b) && (f === void 0 ? w.__staleWhileFetching !== void 0 ? this.#t[e] = w.__staleWhileFetching : this.#v(t, "fetch") : (i.status && (i.status.fetchUpdated = !0), this.#O(t, f, a.options, w))), f;
        }, d = (f)=>(i.status && (i.status.fetchRejected = !0, i.status.fetchError = f), _(f, !1)), _ = (f, b)=>{
            let { aborted: l } = r.signal, S = l && i.allowStaleOnFetchAbort, F = S || i.allowStaleOnFetchRejection, w = F || i.noDeleteOnFetchRejection, m = u;
            if (this.#t[e] === u && (!w || !b && m.__staleWhileFetching === void 0 ? this.#v(t, "fetch") : S || (this.#t[e] = m.__staleWhileFetching)), F) return i.status && m.__staleWhileFetching !== void 0 && (i.status.returnedStale = !0), m.__staleWhileFetching;
            if (m.__returned === m) throw f;
        }, y = (f, b)=>{
            let l = this.#M?.(t, n, a);
            r.signal.addEventListener("abort", ()=>{
                (!i.ignoreFetchAbort || i.allowStaleOnFetchAbort) && (f(void 0), i.allowStaleOnFetchAbort && (f = (S)=>o(S, !0)));
            }), l && l instanceof Promise ? l.then((S)=>f(S === void 0 ? void 0 : S), b) : l !== void 0 && f(l);
        };
        i.status && (i.status.fetchDispatched = !0);
        let u = new Promise(y).then(o, d), p = Object.assign(u, {
            __abortController: r,
    ...
    async #q(t, e = {}) {
        ...
        if (w === void 0) {
            ...
            if (this.#e(m)) {
                ...
                return l && (l.fetch = "inflight", E && (l.returnedStale = !0)), E ? m.__staleWhileFetching : m.__returned = m;
            }
            let A = this.#p(w);
            if (!b && !A) return l && (l.fetch = "hit"), this.#L(w), s && this.#R(w), l && this.#E(l, w), m;
            let z = this.#G(t, w, F, f), v = z.__staleWhileFetching !== void 0 && i;
            return l && (l.fetch = A ? "stale" : "refresh", v && A && (l.returnedStale = !0)), v ? z.__staleWhileFetching : z.__returned = z;
        }
    }
    forceFetch(t, e = {}) {
        let i = g.tracing.hasSubscribers, { status: s = C() ? {} : void 0 } = e;
    ...
    #x(t, e = {}) {
        ...
        return r && this.#E(r, h), this.#p(h) ? o ? (r && (r.get = "stale-fetching"), i && a.__staleWhileFetching !== void 0 ? (r && (r.returnedStale = !0), a.__staleWhileFetching) : void 0) : (n || this.#v(t, "expire"), r && (r.get = "stale"), i ? (r && (r.returnedStale = !0), a) : void 0) : (r && (r.get = o ? "fetching" : "hit"), this.#L(h), s && this.#R(h), o ? a.__staleWhileFetching : a);
    }
    #B(t, e) {
...
"[project]/node_modules/@apollo/server/node_modules/lru-cache/dist/commonjs/node/index.min.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0wo8fic._.js.map